        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('auth.checkReq') }} " method="post">  
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="seller_email" class="col-md-4 col-form-label text-md-right" >Email</label>
                                <div class="col-md-6">
                                    <input type="text" id="seller_email" class="form-control" name="seller_email" value="{{ old('seller_email') }}" >
